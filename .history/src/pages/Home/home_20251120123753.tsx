          ...
          <div className={aboutStyles.aboutContent}>
            <div className={aboutStyles.aboutCaption}>
              ...
              <p className={aboutStyles.aboutText}>
                ...
                celebrar o mais adorável dos heróis: o Homem-Aranha!
                <br /> Aqui você encontra um universo inteiro dedicado ao Amigo
                da Vizinhança, com as últimas novidades do cinema, da TV, dos
                games e das HQs, além de segredos, resenhas e conteúdos feitos
                sob medida para fãs de todas as gerações.
                <br />
                Mais do que informar, queremos guardar cada pedacinho da
                trajetória do herói em um arquivo completo de todas as suas
                revistas. De edições que marcaram época a sagas inesquecíveis e
                itens raros, nosso acervo é perfeito para consultas, estudos e
                para quem ama colecionar e admirar esse personagem tão querido.
                Criamos este site para quem leva a sério a máxima de que grandes
                poderes trazem grandes responsabilidades — e para quem adora
                acompanhar as peripécias de Peter Parker e tudo o que ele
                representa. Explore à vontade e mergulhe no mundo do Aranha como
                você nunca viu!
              </p>
