      ...
      <section className={aboutStyles.aboutContainer}>
        <Container>
          <div className={aboutStyles.aboutCaption}>
            ...
            <p className={aboutStyles.aboutCaption}>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat
              molestias optio sunt doloribus, harum ut eos et! Quis a alias esse
              odio impedit ipsum modi provident. Enim, sed voluptatum odit
              dolore itaque harum dolores reiciendis fugit?
